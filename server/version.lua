...
local resourceName = "hw_mechanicjob"

    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_mechanicjob" then
            resourceName = "hw_mechanicjob (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_mechanicjob/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_mechanicjob/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_mechanicjob"
